module.exports = {
    ...
    data_source: [
      {
        file: 'https://www.aurorahealthcare.org/-/media/aurorahealthcareorg/documents/billing-insurance/hospital-standard-charges/grafton-standard-charges.csv',
        schema: {
  ...
  collection: 'WI',
  common_name: 'Aurora Medical Center in Grafton',
  location: {
