module.exports = {
    ...
    data_source: [
      {
        file: 'https://www.aurorahealthcare.org/-/media/aurorahealthcareorg/documents/billing-insurance/hospital-standard-charges/aurora-baycare-standard-charges.xlsx',
        schema: {
  ...
  collection: 'WI',
  common_name: 'Aurora BayCare Medical Center',
  location: {
